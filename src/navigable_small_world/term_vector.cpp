...
double term_vector::cosineSimilarity(const unordered_map<std::wstring, double>& tf_idf_weights_hash1, const unordered_map<std::wstring, double>& tf_idf_weights_hash2)
{
